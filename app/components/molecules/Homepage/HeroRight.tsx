            ...
            <div className="p-6 flex-grow">
              ...
              <p className="text-gray-200 mt-4">
                ...
                🌟 I enjoy the <span className="text-yellow-300 ">outdoors</span>
                  <a href="/lifestyle-blog" className="inline-block ml-2">
                    <FaExternalLinkAlt className="inline-block text-sm text-yellow-300" />
                  </a>,
                   <span className="text-yellow-300">teaching</span>
                  <a href="/classes" className="inline-block ml-2">
                    <FaExternalLinkAlt className="inline-block text-sm text-yellow-300" />
                  </a>, 
                   <span className="text-yellow-300">painting</span>
                  <a href="/store" className="inline-block ml-2">
                    <FaExternalLinkAlt className="inline-block text-sm text-yellow-300" />
                  </a>, and
                  <FaGamepad className="inline-block mx-2 text-2xl text-yellow-300" /> <span className="text-yellow-300">gaming</span>
                  <a href="/gaming" className="inline-block ml-2">
                    <FaExternalLinkAlt className="inline-block text-sm text-yellow-300" />
                  </a>.
                </span>
              </p>
              <div className="mt-6">
                <a href="/profile" className="inline-block px-6 py-2 bg-blue-700 text-white font-semibold rounded hover:bg-blue-800 transition">
                  View Profile
                </a>
              </div>
            </div>

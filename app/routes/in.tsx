  ...
  return (
   ...
   "footer"`
    ...
    "footer footer"`,
      ...
      gridTemplateRows={['35vh 40vh 15vh', '35vh 40vh 15vh', '35vh 40vh 15vh', '35vh 40vh 18vh']}
      gridTemplateColumns={['40vw 55vw','40vw 55vw ','30vw 65vw', '30vw 65vw']}
      ...
      borderRadius={'lg'}
    >
      <GridItem pl={['4','52px','100px','100px']} bg='' area={'pic'}
      alignSelf={'center'}>
        <PicComp></PicComp>
      </GridItem>
      ...
      <GridItem pl='2' bg='' area={'footer'} display={'flex'} alignSelf={'flex-end'} >
        <Footer/>
      </GridItem>
    </Grid>
  );
